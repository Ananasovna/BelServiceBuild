          ...
          <div className={s.iconTextBlock}>
            ...
            <div className={s.textWithIcon}>
              ...
              <Typography className={s.text1}>
                ...
                зависит поток клиентов, имидж орга&shy;низации, эффек&shy;тивность эксплуа&shy;тации
                простран&shy;ства, а также ре&shy;зуль&shy;та&shy;тив&shy;ность работы персонала.
              </Typography>
              <Typography className={s.text2}>
                ...
                знаний и опыта, а также профес&shy;сиональной технической под&shy;го&shy;тов&shy;ки.
              </Typography>
            </div>
          </div>
