...
export const CartIcon = ({ color = '#000', height = '50px', width = '50px' }: IconProps) => {
  return (
    <svg
    ...
    >
      <g>
        <g opacity={'0.3'}>
          <path
            d={
              'M31.3,126c-2.2,0-4.2-0.5-6.2-1.4l1.7-3.6c1.4,0.7,2.9,1,4.5,1c5.9,0,10.7-4.8,10.7-10.7    c0-5.9-4.8-10.7-10.7-10.7c-1.4,0-2.8,0.3-4.2,0.8l-1.6-3.7c1.8-0.8,3.7-1.2,5.7-1.2c8.1,0,14.7,6.6,14.7,14.7S39.4,126,31.3,126z    '
            }
            fill={color}
          />
        </g>
        <g opacity={'0.3'}>
          <rect fill={color} height={'4'} width={'10'} x={'103.3'} y={'80.5'} />
        </g>
        <g opacity={'0.3'}>
          <rect fill={color} height={'4'} width={'20'} x={'98.3'} y={'96.5'} />
        </g>
        <g opacity={'0.3'}>
          <rect fill={color} height={'4'} width={'30'} x={'93.3'} y={'112.5'} />
        </g>
        <g>
          <path
            d={
        ...
        <g opacity={'0.3'}>
          <path
            d={'M83.8,62.4c-6.9-10.2-18.8-15.6-31-14.2l-0.5-4c13.7-1.6,27,4.5,34.8,15.9L83.8,62.4z'}
            fill={color}
          />
        </g>
      </g>
